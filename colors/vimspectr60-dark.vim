" vimspectr60-dark, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#8a8a72'
  let g:terminal_color_8 =  '#6e6e52'
  let g:terminal_color_9 =  '#b5734c'
  let g:terminal_color_10 = '#2b2b1d'
  let g:terminal_color_11 = '#6e6e52'
  let g:terminal_color_12 = '#8a8a72'
  let g:terminal_color_13 = '#ebebd8'
  let g:terminal_color_14 = '#b57988'
  let g:terminal_color_15 = '#fffff5'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr60-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr60-dark'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr60-dark'
