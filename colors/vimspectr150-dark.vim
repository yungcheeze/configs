" vimspectr150-dark, a vim theme by nightsense
...
" neovim colours
if has('nvim')
  let g:terminal_color_0 =  '#0d1712'
  let g:terminal_color_1 =  '#b55a4c'
  let g:terminal_color_2 =  '#6d8a50'
  let g:terminal_color_3 =  '#b59b4c'
  let g:terminal_color_4 =  '#6a849e'
  let g:terminal_color_5 =  '#8b6a9e'
  let g:terminal_color_6 =  '#508a82'
  let g:terminal_color_7 =  '#778f83'
  let g:terminal_color_8 =  '#547062'
  let g:terminal_color_9 =  '#b5734c'
  let g:terminal_color_10 = '#1f2e26'
  let g:terminal_color_11 = '#547062'
  let g:terminal_color_12 = '#778f83'
  let g:terminal_color_13 = '#d8ebe1'
  let g:terminal_color_14 = '#b57988'
  let g:terminal_color_15 = '#f5fffa'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr150-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr150-dark'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr150-dark'
