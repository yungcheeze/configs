" vimspectr0-dark, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#997f7f'
  let g:terminal_color_8 =  '#806060'
  let g:terminal_color_9 =  '#b5734c'
  let g:terminal_color_10 = '#332222'
  let g:terminal_color_11 = '#806060'
  let g:terminal_color_12 = '#997f7f'
  let g:terminal_color_13 = '#f0dddd'
  let g:terminal_color_14 = '#b57988'
  let g:terminal_color_15 = '#fff5f5'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr0-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr0-dark'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr0-dark'
