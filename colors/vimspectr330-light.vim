" vimspectr330-light, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#7d5e6d'
  let g:terminal_color_8 =  '#997f8c'
  let g:terminal_color_9 =  '#e07638'
  let g:terminal_color_10 = '#f0dde6'
  let g:terminal_color_11 = '#997f8c'
  let g:terminal_color_12 = '#7d5e6d'
  let g:terminal_color_13 = '#33222b'
  let g:terminal_color_14 = '#e0708c'
  let g:terminal_color_15 = '#1f1218'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr330-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr330-light'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr330-light'
