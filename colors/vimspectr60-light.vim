" vimspectr60-light, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#6e6e52'
  let g:terminal_color_8 =  '#8a8a72'
  let g:terminal_color_9 =  '#e07638'
  let g:terminal_color_10 = '#ebebd8'
  let g:terminal_color_11 = '#8a8a72'
  let g:terminal_color_12 = '#6e6e52'
  let g:terminal_color_13 = '#2b2b1d'
  let g:terminal_color_14 = '#e0708c'
  let g:terminal_color_15 = '#17170d'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr60-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr60-light'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr60-light'
