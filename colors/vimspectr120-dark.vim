" vimspectr120-dark, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#778f77'
  let g:terminal_color_8 =  '#547054'
  let g:terminal_color_9 =  '#b5734c'
  let g:terminal_color_10 = '#1f2e1f'
  let g:terminal_color_11 = '#547054'
  let g:terminal_color_12 = '#778f77'
  let g:terminal_color_13 = '#d8ebd8'
  let g:terminal_color_14 = '#b57988'
  let g:terminal_color_15 = '#f5fff5'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr120-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr120-dark'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr120-dark'
