" vimspectr300-dark, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#967d96'
  let g:terminal_color_8 =  '#7d5e7d'
  let g:terminal_color_9 =  '#b5734c'
  let g:terminal_color_10 = '#332233'
  let g:terminal_color_11 = '#7d5e7d'
  let g:terminal_color_12 = '#967d96'
  let g:terminal_color_13 = '#f0ddf0'
  let g:terminal_color_14 = '#b57988'
  let g:terminal_color_15 = '#fff5ff'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr300-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr300-dark'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr300-dark'
