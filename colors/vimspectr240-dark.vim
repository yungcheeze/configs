" vimspectr240-dark, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#81819c'
  let g:terminal_color_8 =  '#636385'
  let g:terminal_color_9 =  '#b5734c'
  let g:terminal_color_10 = '#242436'
  let g:terminal_color_11 = '#636385'
  let g:terminal_color_12 = '#81819c'
  let g:terminal_color_13 = '#dfdff2'
...
if filereadable(expand('~/.vimspectr-shell/vimspectr240-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr240-dark'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr240-dark'
