" vimspectr210-light, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#5a6978'
  let g:terminal_color_8 =  '#7b8794'
  let g:terminal_color_9 =  '#e07638'
  let g:terminal_color_10 = '#dde6f0'
  let g:terminal_color_11 = '#7b8794'
  let g:terminal_color_12 = '#5a6978'
  let g:terminal_color_13 = '#202830'
  let g:terminal_color_14 = '#e0708c'
  let g:terminal_color_15 = '#10161c'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr210-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr210-light'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr210-light'
