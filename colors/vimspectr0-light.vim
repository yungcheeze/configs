" vimspectr0-light, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#806060'
  let g:terminal_color_8 =  '#997f7f'
  let g:terminal_color_9 =  '#e07638'
  let g:terminal_color_10 = '#f0dddd'
  let g:terminal_color_11 = '#997f7f'
  let g:terminal_color_12 = '#806060'
  let g:terminal_color_13 = '#332222'
  let g:terminal_color_14 = '#e0708c'
  let g:terminal_color_15 = '#1f1212'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr0-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr0-light'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr0-light'
