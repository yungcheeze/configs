...
beautiful.init("/home/ucizi/.config/awesome/themes/default/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "p", function () awful.spawn(terminal .. " -e htop") end,
      {description = "view running processes", group = "launcher"}),
    awful.key({ modkey, "Control" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ modkey, "Control"   }, "z", awesome.quit,
              {description = "quit awesome", group = "awesome"}),
    awful.key({ modkey, "Control"   }, "w", function () awful.spawn.with_shell("gnome-screensaver-command --lock") end,
      {description = "quit awesome", group = "awesome"}),
