" vimspectr90-dark, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#808c74'
  let g:terminal_color_8 =  '#627054'
  let g:terminal_color_9 =  '#b5734c'
  let g:terminal_color_10 = '#262e1f'
  let g:terminal_color_11 = '#627054'
  let g:terminal_color_12 = '#808c74'
  let g:terminal_color_13 = '#e1ebd8'
  let g:terminal_color_14 = '#b57988'
  let g:terminal_color_15 = '#fafff5'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr90-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr90-dark'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr90-dark'
