" vimspectr270-dark, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#8c7f99'
  let g:terminal_color_8 =  '#706080'
  let g:terminal_color_9 =  '#b5734c'
  let g:terminal_color_10 = '#2d2436'
  let g:terminal_color_11 = '#706080'
  let g:terminal_color_12 = '#8c7f99'
  let g:terminal_color_13 = '#e9dff2'
  let g:terminal_color_14 = '#b57988'
  let g:terminal_color_15 = '#faf5ff'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr270-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr270-dark'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr270-dark'
