" vimspectrgrey-light, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_12 = '#6b6b6b'
  let g:terminal_color_13 = '#2b2b2b'
...
if filereadable(expand('~/.vimspectr-shell/vimspectrgrey-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectrgrey-light'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectrgrey-light'
