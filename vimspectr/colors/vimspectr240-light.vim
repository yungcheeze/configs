" vimspectr240-light, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#636385'
  let g:terminal_color_8 =  '#81819c'
  let g:terminal_color_9 =  '#e07638'
  let g:terminal_color_10 = '#dfdff2'
  let g:terminal_color_11 = '#81819c'
  let g:terminal_color_12 = '#636385'
  let g:terminal_color_13 = '#242436'
  let g:terminal_color_14 = '#e0708c'
  let g:terminal_color_15 = '#151524'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr240-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr240-light'
  endif
endif
