" vimspectr210-dark, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#7b8794'
  let g:terminal_color_8 =  '#5a6978'
  let g:terminal_color_9 =  '#b5734c'
  let g:terminal_color_10 = '#202830'
  let g:terminal_color_11 = '#5a6978'
  let g:terminal_color_12 = '#7b8794'
  let g:terminal_color_13 = '#dde6f0'
...
if filereadable(expand('~/.vimspectr-shell/vimspectr210-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr210-dark'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr210-dark'
