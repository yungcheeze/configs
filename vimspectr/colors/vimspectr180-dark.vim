" vimspectr180-dark, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#748c8c'
  let g:terminal_color_8 =  '#547070'
  let g:terminal_color_9 =  '#b5734c'
  let g:terminal_color_10 = '#1f2e2e'
  let g:terminal_color_11 = '#547070'
  let g:terminal_color_12 = '#748c8c'
  let g:terminal_color_13 = '#d8ebeb'
  let g:terminal_color_14 = '#b57988'
  let g:terminal_color_15 = '#f5ffff'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr180-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr180-dark'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr180-dark'
