" vimspectr30-light, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#756758'
  let g:terminal_color_8 =  '#918579'
  let g:terminal_color_9 =  '#e07638'
  let g:terminal_color_10 = '#ede4da'
  let g:terminal_color_11 = '#918579'
  let g:terminal_color_12 = '#756758'
  let g:terminal_color_13 = '#302820'
  let g:terminal_color_14 = '#e0708c'
  let g:terminal_color_15 = '#1a140f'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr30-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr30-light'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr30-light'
