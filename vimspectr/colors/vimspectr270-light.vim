" vimspectr270-light, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#706080'
  let g:terminal_color_8 =  '#8c7f99'
  let g:terminal_color_9 =  '#e07638'
  let g:terminal_color_10 = '#e9dff2'
  let g:terminal_color_11 = '#8c7f99'
  let g:terminal_color_12 = '#706080'
  let g:terminal_color_13 = '#2d2436'
  let g:terminal_color_14 = '#e0708c'
  let g:terminal_color_15 = '#1a1321'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr270-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr270-light'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr270-light'
