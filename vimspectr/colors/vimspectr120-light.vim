" vimspectr120-light, a vim theme by nightsense
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#547054'
  let g:terminal_color_8 =  '#778f77'
  let g:terminal_color_9 =  '#e07638'
  let g:terminal_color_10 = '#d8ebd8'
  let g:terminal_color_11 = '#778f77'
  let g:terminal_color_12 = '#547054'
  let g:terminal_color_13 = '#1f2e1f'
  let g:terminal_color_14 = '#e0708c'
  let g:terminal_color_15 = '#0d170d'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr120-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr120-light'
  endif
endif
...
hi clear
syntax reset
let g:colors_name = 'vimspectr120-light'
